...
const AuthScreen = () => {
  ...
  return (
    <div className=" hero-bg  relative">
      ...
      {/* 2nd Section */}
      <div className=" py-10 bg-black text-white">
        <div className=" flex max-w-6xl flex-col-reverse mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          {/* Left Side */}
          <div className=" flex-1 ">
            <div className=" relative">
              <img src="/stranger-things-lg.png" className=" mt-4" />
              <div className=" absolute flex items-center gap-2 bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
                <img src="/stranger-things-sm.png" className=" h-full" />
      ...
      <div className=" py-10 bg-black text-white">
        <div className=" flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          {/* left */}
          <div className=" flex-1 relative">
            <img src="/kids.png" className=" mt-4" />
          </div>
          {/* Right */}
          <div className=" flex-1 text-center md:text-left">
            <h2 className=" text-4xl md:text-5xl font-extrabold mb-4">
